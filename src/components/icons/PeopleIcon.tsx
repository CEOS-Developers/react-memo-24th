...
type PeopleIconProps = SVGProps<SVGSVGElement> & {
  size?: number | string;
};

export default function PeopleIcon({ size, ...props }: PeopleIconProps) {
  return (
    <svg
      width={size ?? 32}
      height={size ?? 32}
